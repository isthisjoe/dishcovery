...
ActiveRecord::Schema.define(:version => 20111102231541) do
  ...
  add_index "gradings", ["dish_id"], :name => "index_gradings_on_dish_id"
  add_index "gradings", ["grade_id"], :name => "index_gradings_on_grade_id"
  add_index "gradings", ["user_id"], :name => "index_gradings_on_user_id"
